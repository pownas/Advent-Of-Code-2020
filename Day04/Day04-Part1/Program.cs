...
{
    int n = 0;
    n += passport.ContainsKey("pid") ? 1 : 0;
    n += passport.ContainsKey("byr") ? 1 : 0;
    n += passport.ContainsKey("iyr") ? 1 : 0;
    n += passport.ContainsKey("eyr") ? 1 : 0;
    n += passport.ContainsKey("hgt") ? 1 : 0;
    n += passport.ContainsKey("hcl") ? 1 : 0;
    n += passport.ContainsKey("ecl") ? 1 : 0;
    if (n >= 7)
    {
